	...
	<div class="container-fluid"
		...
		<div class="col-sm-2">
			<div class="row">
				...
				<ul class="nav nav-sidebar arrow" style="width: 200px">
					...
					<li><a href="" style="color: #FF0000">Thư đã gửi (8)</a></li>
		...
		<div>
			<h2 style="font-size: 30px; color: #FF2424; text-align: center;"
				class="panel-title">Thư đã gửi</h2>
							...
							<table class="table table-hover" style="text-align: left">
								<tbody>
									<tr id="tr1">
										...
										<td>Tới: LyCan</td>
										<td>Cảm ơn bạn vì đã ủng hộ toeicc123.com. Chúc
											bạn học tốt.</td>
									...
									<tr id="tr2">
										...
										<td>Tới: CaoTri</td>
										<td>Mật khẩu của bạn đã được kích hoạt. Vui lòng
											kiểm tra lại.</td>
									...
									<tr id="tr4">
										...
										<td>Tới: ThuThao</td>
										<td>Chúng tôi đã đáp ứng yêu cầu của bạn. Chúc
											bạn học tốt.</td>
									...
									<tr id="tr5">
										...
										<td>Tới: HocChamChi</td>
										<td>Xin chân thành cảm ơn bạn. Chúng tôi sẽ cố
											gắng làm tốt hơn nữa.</td>
									...
									<tr id="tr6">
										...
										<td>Tới: FFFFAAA</td>
										<td>Xin cảm ơn bạn đã góp ý. Chúng tôi sẽ cố
											gắng làm tốt hơn.</td>
										<td>16:20:00 22/09/2016</td>
									</tr>
									<tr id="tr7">
										<td><label> <input type="checkbox" value=""
