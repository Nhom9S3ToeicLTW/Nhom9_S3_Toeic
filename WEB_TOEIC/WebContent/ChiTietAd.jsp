						...
						<div class="dropdown user-pro-body">
							<div>
								<img src="img\Avatar.jpg" alt="user-img" class="img-circle"
									style="width: 200px; height: 200px; margin-left: 45px;">
							</div>
							<div>
						...
						<div class="form-group">
							<div class="col-sm-12">
								<div class="row">
									...
									<div class="col-sm-9">
										<h4>
											Ngô Thanh Đông <a><button id="fullname" type="button"
													class="btn btn-link">
						...
						<div class="form-group">
							<div class="col-sm-12">
								<div class="row">
									...
									<div class="col-sm-9">
										<h4>14110039@student.hcmute.edu.vn</h4>
									</div>
								</div>
							</div>
						</div>
						<div class="form-group">
							<div class="col-sm-12">
								<div class="row">
									...
									<div class="col-sm-9">
										<h4>
											01652010171 <a><button id="mobile" type="button"
													class="btn btn-link">
													<span class="glyphicon glyphicon-pencil"></span></button></a></h4>
									</div>
								</div>
						...
						<div class="form-group">
							<div class="col-sm-12">
								<div class="row">
									...
									<div class="col-sm-9">
										<h4>
											04/06/1996 <a><button id="birthday" type="button"
													class="btn btn-link">
													<span class="glyphicon glyphicon-pencil"></span></button></a>
										</h4>
									</div>
