	...
	<div class="wrapper">
		<div class="content">
			<div id="form_wrapper" class="form_wrapper">
				<form class="register" name="registerForm" ng-submit="submitForm(registerForm.$valid)" novalidate>
					<h3>Register</h3>
					<div class="column">
				...
				<form class="login active" name="loginForm" ng-submit="submitForm(loginForm.$valid)" novalidate>
					<h3>Login</h3>
