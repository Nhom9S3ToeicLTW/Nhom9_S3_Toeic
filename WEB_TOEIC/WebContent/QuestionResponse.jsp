			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="myNavbar">
					<ul class="nav navbar-nav">
						...
						<li class="active"><a href="TrangChuUser.jsp">Upload
								tài liệu</a></li>
		...
		<div class="container-fluid"
				...
				<div class="row">
					<div class="dropdown user-pro-body">
						...
						<ul class="dropdown-menu animated flipInY">
							...
							<li role="separator" class="divider"></li>
							<li><a href="">Thông báo mới <span class="badge">0</span></a>
							</li>
						</ul>
					</div>
					<div class="container">
						<div class="dropdown" style="max-width: 100px;">
							...
							<ul class="dropdown-menu">
								...
								<li class="active"><a href="QuestionResponse.jsp">Question
										Response</a></li>
			...
			<div>
				<h2 style="font-size: 30px; color: #FF2424; text-align: center;"
					class="panel-title">Question Response</h2>
