			...
			<div class="content">
				<div id="form_wrapper" class="form_wrapper">
					<form class="register" name="registerForm"
						ng-submit="submitForm(registerForm.$valid)" novalidate>
						<h3>Register</h3>
						<div class="column">
							<div class="form-group"
								...
								<label>Fullname:</label> <input type="text" name="fullname"
									class="form-control" placeholder="Ngô Thanh Đông"
									ng-model="user.fullname" required>
								<p class="error"
									ng-show="registerForm.fullname.$invalid && !registerForm.fullname.$pristine"
									class="help-block">You fullname is required.</p>
							</div>
							...
							<div class="form-group"
								...
								<label>Username:</label> <input type="text" name="username"
									...
									required>
								<p class="error"
									ng-show="registerForm.username.$error.minlength"
									class="help-block">Username is too short.</p>
								<p class="error"
									ng-show="registerForm.username.$error.maxlength"
							...
							<div class="form-group"
								...
								<p class="error"
									ng-show="registerForm.password.$error.maxlength"
						...
						<div class="column">
							<div class="form-group"
								...
								<label>Email:</label> <input type="email" name="email"
									class="form-control" placeholder="dongnt2015@gmail.com"
									ng-model="user.email">
								<p class="error"
							...
							<div class="form-group"
								...
								<label>Mobile:</label> <input type="tel" name="mobile"
									class="form-control" placeholder="01652010171"
							...
							<div class="form-group"
								ng-class="{ 'has-error' : registerForm.birthday.$invalid && !registerForm.birthday.$pristine }">
								<label>Your birth day:</label> <input type="text"
									name="birthday" class="form-control" placeholder="04-06-1996"
									ng-model="user.birthday"
									ng-pattern="/^(0?[1-9]|[12][0-9]|3[01])-(0?[1-9]|1[012])-((19[0-9]{2})|(20[0-1]{1}[0-4]{1}))$/"
									required>
								<p class="error"
									ng-show="registerForm.birthday.$invalid && !registerForm.birthday.$pristine"
									class="help-block">Enter a valid email.</p>
							</div>
							<br>
						</div>
						...
						<div class="bottom">
							...
							<input type="submit" value="Register" /> <a href="index.jsp"
					...
					<form class="login" name="loginForm"
						...
						<div class="form-group"
							...
							<label>Password:<a href="forgot_password.jsp"
								rel="forgot_password" class="forgot linkform">Forgot your
									password?</a></label> <input type="password" name="password"
								class="form-control" placeholder="12345678"
								ng-model="user.password" ng-minlength="6" ng-maxlength="15"
								required>
						...
						<div class="bottom">
							...
							<input type="submit" value="Login"></input> <a
								href="register.jsp" rel="register" class="linkform">You
								don't have an account yet? Register here</a>
							<div class="clear"></div>
						</div>
					</form>

					<form class="forgot_password active" name="forpasForm"
						ng-submit="submitForm(forpasForm.$valid)" novalidate>
						<h3>Forgot Password</h3>
						<div class="form-group"
							ng-class="{ 'has-error' : forpasForm.email.$invalid && !forpasForm.email.$pristine }">
							<label>Email:</label> <input type="email" name="email"
								class="form-control" placeholder="dongnt2015@gmail.com"
								ng-model="user.email">
							<p class="error"
								ng-show="forpasForm.email.$invalid && !forpasForm.email.$pristine"
								class="help-block">Enter a valid email.</p>
						</div>
						<div class="bottom">
							<input type="submit" value="Send reminder"></input> <a
								href="index.jsp" rel="login" class="linkform">Suddenly
								remebered? Log in here</a>
							<div class="clear"></div>
							<a href="register.jsp" rel="register" class="linkform">You
