		...
		<div class="container-fluid"
				...
				<div class="row">
					<div class="dropdown user-pro-body">
						...
						<ul class="dropdown-menu animated flipInY">
							...
							<li role="separator" class="divider"></li>
							<li><div>
									<span class="glyphicon glyphicon-envelope"></span> Thông báo
									mới <a class="mess bg_mess_nmess" href="#"><span
					...
					<div class="container">
						<div class="dropdown" style="max-width: 100px;">
							...
							<ul class="dropdown-menu">
								...
								<li class="active"><a href="ReadingComprehension.jsp">Reading
										Comprehension</a></li>
							</ul>
						</div>
					</div>
			...
			<div>
				<h2 style="font-size: 30px; color: #FF2424; text-align: center;"
					class="panel-title">Reading Comprehension</h2>
									...
									<form class="form-horizontal">
										<div class="container">
											<form class="form-horizontal">
												...
												<div class="form-group">
													<br> <label class="control-label col-sm-2"
														for="comment">Mô tả:</label>
													<div class="col-sm-10">
