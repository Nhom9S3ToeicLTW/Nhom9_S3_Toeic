			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="myNavbar">
					<ul class="nav navbar-nav">
						...
						<li class="active"><a href="TrangChuUser.jsp">Upload tài
								liệu</a></li>
	...
	<div class="container-fluid"
			...
			<div class="row">
				...
				<div class="container">
					<div class="dropdown" style="max-width: 100px;">
						...
						<ul class="dropdown-menu">
							<li><a href="TrangChuUser.jsp">Photographs</a></li>
							<li><a href="QuestionResponse.jsp">Question Response</a></li>
							<li class="active"><a href="ShortConversation.jsp">Short
									Conversation</a></li>
				...
				<div class="container">
					<div class="dropdown" style="max-width: 100px;">
						...
						<ul class="dropdown-menu">
							<li><a href="IncompleteSentences.jsp">Incomplete
									Sentence</a></li>
							<li><a href="TextCompletion.jsp">Text Completion</a></li>
							<li><a href="ReadingComprehension.jsp">Reading
									Comprehension</a></li>
						</ul>
					</div>
				</div>
		...
		<div>
			<h2 style="font-size: 30px; color: #FF2424; text-align: center;"
				class="panel-title">Short Conversation</h2>
							...
							<div class="panel panel-default">
								<form class="form-horizontal">
									<div class="form-group container">
										<br> <label class="control-label col-sm-2" for="usr">Tên
											tài liệu:</label>
										<div class="col-sm-10">
											<input type="text" class="form-control" id="usr" value="lqr_">
										</div>
											...
											<table>
												<tbody>
													<tr>
														...
														<td><label class="btn-upload"> <input
									...
									<div class="container">
										<form class="form-horizontal">
											<div class="form-group">
												<label class="control-label col-sm-2" for="usr">Mô
													tả:</label>
												<div class="col-sm-10">
											...
											<div class="form-group">
												<br> <label class="control-label col-sm-2" for="usr">1:</label>
												<div class="col-sm-10">
													<input type="text" class="form-control" id="cau1">
												</div>
											</div>
											<div class="form-group">
											...
											<div class="form-group">
												<label class="control-label col-sm-2" for="kq">Kết
													quả đúng:</label>
												<div class="col-sm-10">
									...
									<div class="container">
										<form class="form-horizontal">
											<div class="form-group">
												<br> <label class="control-label col-sm-2" for="usr">2:</label>
												<div class="col-sm-10">
													<input type="text" class="form-control" id="cau1">
												</div>
											</div>
									...
									<div class="container">
										<form class="form-horizontal">
											<div class="form-group">
												<br> <label class="control-label col-sm-2" for="usr">3:</label>
												<div class="col-sm-10">
													<input type="text" class="form-control" id="cau1">
												</div>
											</div>
									...
									<br> <a href="#" class="button1"
										style="float: right; margin: 20px;">Save</a> <a
										href="TrangChuUser.jsp" class="button1"
										style="float: right; margin: 20px;">Return</a> <br> <br>
									<br> <br>
								</form>
							</div>
						</div>
